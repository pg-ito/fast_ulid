...
class FastUlidTest extends TestCase{
    ...
    public function testSameTimeGen(){
        $fixed_timestamp = (float)1660869868;// 2022-08-19 09:44:28
        $ulid1 = FastUlid::gen($fixed_timestamp);
        $ulid2 = FastUlid::gen($fixed_timestamp);
        $this->assertNotSame($ulid1, $ulid2);       
    }    
    public function testGenBase32(){
        $ulid1 = FastUlid::gen();
        $matches = null;
        preg_match('/[0123456789ABCDEFGHJKMNPQRSTVWXYZ]{26}/', $ulid1, $matches);
    ...
    public function testShortTimestampFutureLength(){
        ...
        preg_match('/[0123456789ABCDEFGHJKMNPQRSTVWXYZ]{10}/', $short_timestamp1, $matches);
